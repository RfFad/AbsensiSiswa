const {InsertHari,UpdateHari, HariById, getHari, DeleteHari } = require('../models/models_hari');
...
module.exports = {getInsertHari, getPageHari, getDataHari, getDeleteHari, getUpdateHari, getUpdatePageHari}
