const { InsertMapel, getMapel, getMapelById, UpdateMapel, DeleteMapel } = require('../models/models_mapel');
...
module.exports = { getPageMapel, getInsertMapel, getDataMapel, getUpdatePageMapel, getUpdateMapel, getDeleteMapel };
