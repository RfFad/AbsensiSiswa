const { InsertKelas, getKelas, getKelasById, UpdateKelas, DeleteKelas } = require('../models/models_kelas');
const getDataKelas = async (req, res) => {
    try {
        ...
        res.render("admin/kelas", { row, index: 1, messages });  // Removed the leading slash
    } catch (error) {
...
const getUpdatePageKelas = async (req, res) => {
    ...
    try {
        ...
        res.render('admin/edit_kelas', {kelas, messages})
    } catch (error) {
...
module.exports = { getPageKelas, getInsertKelas, getDataKelas, getUpdatePageKelas, getUpdateKelas, getDeleteKelas };
