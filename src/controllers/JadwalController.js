...
const jadwal = {
 ...
 getPageInsert : async (req, res) => {
    try {
        ...
        res.render('admin/jadwal/crud_jadwal', {messages, guru, kelas, mapel, hari})
    } catch (error) {
        console.error("Error rendering the page:", error);
 ...
 getInsertJadwal : async (req, res) => {
    ...
    try {
        ...
        await jadwalmodel.InsertJadwal(idh, idg, idk, idm, jam_mulai, jam_selesai); // Use the hashed password
...
getUpdatePage : async (req, res) => {
    ...
    try {
        ...
        res.render("admin/jadwal/edit", { jadwal, guru, kelas, mapel, hari, messages });
    } catch (error) {
...
getUpdateInsert : async (req, res) => {
    ...
    try {
        ...
        await jadwalmodel.UpdateJadwal(idj, idh, idg, idk, idm, jam_mulai, jam_selesai); // Use the hashed password
